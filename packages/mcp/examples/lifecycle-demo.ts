...
async function demonstrateSingleCycle(): Promise<void> {
    console.log('╔══════════════════════════════════════════════════════════════════╗');
    console.log('║        Deep Tree Echo - Developmental Lifecycle Demo            ║');
    console.log('╚══════════════════════════════════════════════════════════════════╝\n');
    ...
    console.log('📍 Server started. Running developmental lifecycle demonstration...\n');
    ...
    printVirtualAgentState('Initial Vi (Virtual Agent)', server.getVirtualAgent());
    printVirtualArenaState('Initial Vo (Virtual Arena)', server.getVirtualArena());

    // Execute each phase individually with explanation
    console.log('\n═══════════════════════════════════════════════════════════════════');
    console.log('            PHASE 1: PERCEPTION (Ao → Ai)                         ');
    console.log('═══════════════════════════════════════════════════════════════════');
    ...
    console.log(`✓ Perception complete. Coherence: ${perceptionResult.coherenceAfter.toFixed(3)}\n`);

    console.log('═══════════════════════════════════════════════════════════════════');
    console.log('            PHASE 2: MODELING (Ai → S)                            ');
    console.log('═══════════════════════════════════════════════════════════════════');
    console.log('The agent processes experience through the relational self (S).');
    console.log('This integrates perception with the agent\'s identity structure.\n');

    const modelingResult = await server.executePhase(LifecyclePhase.MODELING);
    console.log(`✓ Modeling complete. Coherence: ${modelingResult.coherenceAfter.toFixed(3)}\n`);

    console.log('═══════════════════════════════════════════════════════════════════');
    console.log('            PHASE 3: REFLECTION (S → Vi)                          ');
    console.log('═══════════════════════════════════════════════════════════════════');
    ...
    console.log(`✓ Reflection complete. Coherence: ${reflectionResult.coherenceAfter.toFixed(3)}\n`);

    console.log('═══════════════════════════════════════════════════════════════════');
    console.log('      PHASE 4: MIRRORING (Vi ↔ Vo) - THE INVERTED MIRROR         ');
    console.log('═══════════════════════════════════════════════════════════════════');
    console.log('The self-model (Vi) updates the world-view (Vo) bidirectionally.');
    ...
    console.log(`✓ Mirroring complete. Coherence: ${mirroringResult.coherenceAfter.toFixed(3)}\n`);
    ...
    console.log('═══════════════════════════════════════════════════════════════════');
    console.log('            PHASE 5: ENACTION (Vo → Ao)                           ');
    console.log('═══════════════════════════════════════════════════════════════════');
    ...
    console.log(`✓ Enaction complete. Coherence: ${enactionResult.coherenceAfter.toFixed(3)}\n`);
...
async function demonstrateMultipleCycles(): Promise<void> {
    console.log('\n╔══════════════════════════════════════════════════════════════════╗');
    console.log('║         Multiple Lifecycle Cycles Demonstration                 ║');
    console.log('╚══════════════════════════════════════════════════════════════════╝\n');
    ...
    for (let i = 1; i <= numCycles; i++) {
        ...
        console.log(`\n   📊 Self-awareness accuracy: ${(va.selfAwareness.perceivedAccuracy * 100).toFixed(1)}%`);
        console.log(`   📊 World-view drift: ${vo.divergenceMetrics.estimatedDrift.toFixed(3)}`);
    }
...
async function demonstrateVirtualModelAccess(): Promise<void> {
    console.log('\n╔══════════════════════════════════════════════════════════════════╗');
    console.log('║          Virtual Model Access via MCP Resources                 ║');
    console.log('╚══════════════════════════════════════════════════════════════════╝\n');
    ...
    console.log(`   Self-story: "${(viResource as VirtualAgentModel).selfStory}"`);
    console.log(`   Current goals: ${(viResource as VirtualAgentModel).currentGoals.join(', ')}\n`);
    ...
    console.log(`   World theory: "${(voResource as VirtualArenaModel).worldTheory}"`);
    console.log(`   Uncertainties: ${(voResource as VirtualArenaModel).uncertainties.slice(0, 2).join(', ')}\n`);
...
function printVirtualAgentState(title: string, vi: VirtualAgentModel): void {
    ...
    console.log(`   Perceived capabilities: ${vi.perceivedCapabilities.slice(0, 3).join(', ')}`);
    console.log(`   Role understanding: "${vi.roleUnderstanding}"`);
    console.log(`   Self-awareness accuracy: ${(vi.selfAwareness.perceivedAccuracy * 100).toFixed(1)}%`);
    console.log('');
}
...
function printVirtualArenaState(title: string, vo: VirtualArenaModel): void {
    console.log(`🌍 ${title}:`);
    console.log(`   Perceived context: "${vo.situationalAwareness.perceivedContext}"`);
    console.log(`   World theory: "${vo.worldTheory}"`);
    console.log(`   Estimated coherence: ${vo.situationalAwareness.estimatedCoherence.toFixed(3)}`);
    console.log(`   Estimated drift: ${vo.divergenceMetrics.estimatedDrift.toFixed(3)}`);
    console.log(`   Known misalignments: ${vo.divergenceMetrics.knownMisalignments.length}`);
    console.log('');
}
