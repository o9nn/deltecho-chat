...
import { relationToolSchemas, createRelationTools, listRelationTools } from '../../relation-mcp/tools.js';
...
describe('Relation Tool Schemas', () => {
    ...
    describe('integrate schema', () => {
        ...
        it('should validate all developmental phases', () => {
            const phases = ['perception', 'modeling', 'reflection', 'mirroring', 'enaction'];
    ...
    describe('addInsight schema', () => {
        ...
        it('should validate all insight sources', () => {
            ...
            sources.forEach(source => {
                const result = relationToolSchemas.addInsight.parse({ insight: 'Test', source });
...
describe('Relation Tools', () => {
    ...
    describe('updateVirtualArena', () => {
        it('should update the virtual arena (Vo)', () => {
            ...
            expect(result).toBeDefined();
            expect(result.situationalAwareness.perceivedContext).toBe('Changed context');
