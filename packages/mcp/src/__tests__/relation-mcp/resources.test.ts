...
function createMockRelation(): RelationInterface {
    return {
        ...
        getRecentFlows: vi.fn(() => [
            { direction: 'agent-to-arena', content: 'Response generated', timestamp: Date.now() },
            { direction: 'arena-to-agent', content: 'Context absorbed', timestamp: Date.now() - 100 },
            { direction: 'bidirectional', content: 'Synthesis complete', timestamp: Date.now() - 200 },
        ]),
...
describe('Relation Resources', () => {
    ...
    describe('relationResources', () => {
        ...
        describe('relation://flows', () => {
            ...
            it('should filter by direction', () => {
                ...
                expect(agentFlows.every(f => f.direction === 'agent-to-arena')).toBe(true);
            });
        ...
        describe('relation://virtual-arena', () => {
            ...
            it('should demonstrate inverted mirror structure', () => {
                ...
                expect(vo.situationalAwareness.perceivedContext).toBe('Active conversation');
            });
        });
    });
    ...
    describe('listRelationResources', () => {
        ...
        it('should show coherence percentage in identity description', () => {
            const resources = listRelationResources(relation);
            const identityResource = resources.find(r => r.uri === 'relation://identity');
        ...
        it('should reference inverted mirror in virtual-arena description', () => {
            const resources = listRelationResources(relation);
            const voResource = resources.find(r => r.uri === 'relation://virtual-arena');
