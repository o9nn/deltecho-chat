...
export const relationResources = {
    ...
    'relation://flows': {
        schema: z.object({
            ...
            direction: z.enum(['agent-to-arena', 'arena-to-agent', 'bidirectional', 'all']).optional(),
        }),
        handler: (
...
export function listRelationResources(
    ...
    return [
        ...
        },
        {
            ...
            description: `Coherence: ${(emergentIdentity.coherence * 100).toFixed(0)}%, Themes: ${emergentIdentity.activeThemes.length}`,
        },
        {
            uri: 'relation://coherence',
            name: 'Coherence Metric',
            description: `Overall system coherence: ${(relation.getCoherence() * 100).toFixed(1)}%`,
        },
        {
            uri: 'relation://virtual-agent',
