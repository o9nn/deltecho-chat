...
import { Live2DAvatar, Live2DAvatarController, EmotionalVector } from './Live2DAvatar';
...
export const VideoCalibrationLab: React.FC = () => {
    ...
    const handleVideoPlay = () => {
        if (!videoRef.current || !audioContextRef.current || !analyserRef.current) return;
    ...
    return (
        <div className="video-calibration-lab">
            <div className="lab-header">
                <h3><Video size={24} /> Avatar Calibration Lab</h3>
                <p>Use reference videos to tune avatar lip-sync and expression mapping.</p>
            </div>
