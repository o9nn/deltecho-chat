  ...
  return (
    <>
      ...
      <div style={{ marginBottom: '16px' }}>
        <p style={{ margin: '0 0 10px 0', fontSize: '14px', color: 'var(--color-text)' }}>
          Manage your AI personalities and interactions in the dedicated dashboard.
        </p>
      ...
      <div style={{ marginBottom: '20px' }}>
        {apiKeys.map(key => (
          <div key={key.id} style={{
            ...
            <div>
              ...
              <div style={{ fontSize: '12px', opacity: 0.8 }}>{key.platform}</div>
            </div>
            <button
        ...
        {apiKeys.length === 0 && (
          <div style={{ fontStyle: 'italic', opacity: 0.6, marginBottom: '10px' }}>
      ...
      <div style={{ marginBottom: '10px' }}>
        <select
          ...
          onChange={(e) => setNewKey({ ...newKey, platform: e.target.value as any })}
