...
export const FEATURE_FLAG_CONFIGS: Record<FeatureFlag, FeatureFlagConfig> = {
    [FeatureFlag.TENSORFLOW]: {
        ...
        name: 'TensorFlow.js',
        description: 'Enable machine learning capabilities. May increase memory usage.',
    ...
    [FeatureFlag.VISION]: {
        ...
        description: 'Enable image analysis and understanding. Requires TensorFlow.js.',
        defaultEnabled: false,
        performanceImpact: 'high',
        experimental: false,
    },
    [FeatureFlag.PROACTIVE_MESSAGING]: {
        ...
        description: 'Allow AI to initiate conversations based on triggers and schedules.',
        defaultEnabled: true,
    ...
    [FeatureFlag.MEMORY_CONSOLIDATION]: {
        ...
        description: 'Background process for organizing and strengthening AI memories.',
        defaultEnabled: true,
    ...
    [FeatureFlag.EMBODIMENT]: {
        ...
        description: 'Enable proprioceptive and embodiment features for richer AI experience.',
        defaultEnabled: false,
        performanceImpact: 'low',
        experimental: true,
    },
...
export class FeatureFlags {
    ...
    async initialize(): Promise<void> {
        ...
        try {
            ...
            for (const [flagId, config] of Object.entries(FEATURE_FLAG_CONFIGS)) {
                ...
                const enabled = typeof storedValue === 'boolean'
                    ? storedValue
     ...
     */
    addListener(listener: (flag: FeatureFlag, enabled: boolean) => void): () => void {
    ...
    isAvailable(flag: FeatureFlag): boolean {
        ...
        if (flag === FeatureFlag.VISION) {
            return this.isEnabled(FeatureFlag.TENSORFLOW) && this.isEnabled(FeatureFlag.VISION)
        }
