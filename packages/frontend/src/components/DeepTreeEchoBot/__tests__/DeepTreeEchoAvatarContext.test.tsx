...
function TestConsumer() {
    ...
    return (
        <div>
            ...
            <span data-testid="is-speaking">{avatar.state.isSpeaking.toString()}</span>
            <span data-testid="audio-level">{avatar.state.audioLevel}</span>
            <button
                data-testid="set-listening"
                onClick={() => avatar.setProcessingState(AvatarProcessingState.LISTENING)}
            >
                Set Listening
            </button>
            <button
...
describe('DeepTreeEchoAvatarContext', () => {
    ...
    describe('useDeepTreeEchoAvatar', () => {
        it('should throw when used outside provider', () => {
            ...
            expect(() => {
                render(<TestConsumer />)
            }).toThrow('useDeepTreeEchoAvatar must be used within DeepTreeEchoAvatarProvider')
