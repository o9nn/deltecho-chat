...
describe('BotSettings Component', () => {
    ...
    it('renders settings form after loading', async () => {
        ...
        expect(screen.getByPlaceholderText('Enter your default API key')).toHaveValue('test-api-key')
    })
    ...
    it('toggles bot enabled state', async () => {
        ...
        expect(runtime.setDesktopSetting).toHaveBeenCalledWith('deepTreeEchoBotEnabled', false)
    })
    ...
    it('handles memory toggle correctly', async () => {
        ...
        const memoryInput = document.getElementById('memory-toggle') as HTMLInputElement
        ...
        expect(runtime.setDesktopSetting).toHaveBeenCalledWith('deepTreeEchoBotMemoryEnabled', true)
    ...
    it('toggles advanced settings visibility', async () => {
        ...
        expect(screen.getByText('Advanced Cognitive Architecture')).toBeInTheDocument()
    })
})
