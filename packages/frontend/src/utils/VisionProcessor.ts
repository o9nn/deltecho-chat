...
export class VisionProcessor {
     ...
     */
    public static async extractVideoFrames(videoUrl: string, numFrames: number = 3): Promise<string[]> {
        return new Promise((resolve, reject) => {
            ...
            video.onloadedmetadata = async () => {
                try {
                    ...
                    const timestamps = Array.from({ length: numFrames }, (_, i) => (duration * (i + 1)) / (numFrames + 1));
