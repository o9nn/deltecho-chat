...
describe('SharedMemoryManager', () => {
    ...
    test('should publish public atoms', async () => {
        const atom = new Node('test-public', AtomType.ConceptNode, undefined, undefined, 'public');
    ...
    test('should reject private atoms', async () => {
        const atom = new Node('test-private', AtomType.ConceptNode, undefined, undefined, 'private');
        const success = await manager.publishAtom(atom);
    ...
    test('should notify subscribers', async () => {
        ...
        const atom = new Node('subscribe-test', AtomType.ConceptNode, undefined, undefined, 'public');
