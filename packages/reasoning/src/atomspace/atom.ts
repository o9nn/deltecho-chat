...
export abstract class Atom {
    ...
    constructor(id: string, type: AtomType, tv: TruthValue = createTruthValue(), vector?: number[], visibility: 'public' | 'private' | 'shared' = 'private', originId?: string) {
        this.id = id;
        this.type = type;
        this.truthValue = tv;
...
export class Node extends Atom {
    ...
    constructor(name: string, type: AtomType = AtomType.ConceptNode, tv: TruthValue = createTruthValue(), vector?: number[], visibility: 'public' | 'private' | 'shared' = 'private', originId?: string) {
...
export class Link extends Atom {
    ...
    constructor(type: AtomType, outgoing: Atom[], tv: TruthValue = createTruthValue(), visibility: 'public' | 'private' | 'shared' = 'private', originId?: string) {
