...
export class VirtualEndocrineSystem extends EventEmitter {
  ...
  getSimplifiedSnapshot(): {
    ...
    return {
      ...
      dopamine:
        (this.hormones[Hormone.DOPAMINE_TONIC] +
          this.hormones[Hormone.DOPAMINE_PHASIC]) /
        2,
  ...
  computeValence(): ValenceSignature {
    ...
    const negative =
      this.hormones[Hormone.CORTISOL] +
  ...
  getState(): {
    ...
    for (const [gland] of this.glands) {
  ...
  private decayTick(): void {
    ...
    for (const [, config] of this.glands) {
      for (const hormone of config.hormones) {
        const current = this.hormones[hormone];
        const baseline = config.baseline;
        // Exponential decay toward baseline
        const decayed =
          baseline + (current - baseline) * Math.exp(-config.decayRate * dt);
    ...
    return [
      {
        ...
        weights: {
          [Hormone.DOPAMINE_TONIC]: 1.5,
          [Hormone.NOREPINEPHRINE]: 0.8,
          [Hormone.CORTISOL]: -1.0,
        },
      },
      {
        mode: CognitiveMode.STRESSED,
        weights: {
          [Hormone.CORTISOL]: 1.5,
          [Hormone.NOREPINEPHRINE]: 1.0,
          [Hormone.SEROTONIN]: -0.8,
        },
      },
      {
        mode: CognitiveMode.SOCIAL,
        weights: {
          [Hormone.OXYTOCIN]: 1.5,
          [Hormone.SEROTONIN]: 0.8,
          [Hormone.CORTISOL]: -0.5,
        },
      },
      {
        mode: CognitiveMode.FOCUSED,
        weights: {
          [Hormone.NOREPINEPHRINE]: 1.2,
          [Hormone.T3]: 0.8,
          [Hormone.MELATONIN]: -1.5,
        },
      },
      {
        ...
        weights: {
          ...
          [Hormone.NOREPINEPHRINE]: 1.2,
          [Hormone.GLUCAGON]: 1.0,
        },
      },
      {
        mode: CognitiveMode.REFLECTIVE,
        weights: {
          [Hormone.SEROTONIN]: 1.5,
          [Hormone.NOREPINEPHRINE]: -1.0,
          [Hormone.MELATONIN]: 0.5,
        },
      },
      {
      ...
      },
      {
        ...
        weights: {
          [Hormone.ANANDAMIDE]: 1.5,
          [Hormone.DOPAMINE_TONIC]: 0.8,
          [Hormone.CORTISOL]: -0.8,
        },
      },
      {
        mode: CognitiveMode.REST,
        weights: {
          [Hormone.MELATONIN]: 2.0,
          [Hormone.NOREPINEPHRINE]: -1.5,
          [Hormone.CORTISOL]: -1.0,
        },
      },
      {
