...
describe('LipSyncGenerator', () => {
    ...
    describe('configuration', () => {
        it('should use default config', () => {
            ...
            expect(config.averagePhoneDuration).toBe(DEFAULT_LIPSYNC_CONFIG.averagePhoneDuration);
        });
...
describe('phonemeToMouthShape', () => {
    it('should return closed mouth for B phoneme', () => {
        const entry: PhonemeEntry = { phoneme: 'B', startTime: 0, duration: 100, intensity: 1.0 };
    ...
    it('should return open mouth for A phoneme', () => {
        const entry: PhonemeEntry = { phoneme: 'A', startTime: 0, duration: 100, intensity: 1.0 };
        const shape = phonemeToMouthShape(entry);
    ...
    it('should return round lips for E phoneme', () => {
        const entry: PhonemeEntry = { phoneme: 'E', startTime: 0, duration: 100, intensity: 1.0 };
        const shape = phonemeToMouthShape(entry);
    ...
    it('should return wide mouth for D phoneme', () => {
        const entry: PhonemeEntry = { phoneme: 'D', startTime: 0, duration: 100, intensity: 1.0 };
        const shape = phonemeToMouthShape(entry);
    ...
    it('should scale with intensity', () => {
        const highIntensity: PhonemeEntry = { phoneme: 'A', startTime: 0, duration: 100, intensity: 1.0 };
        const lowIntensity: PhonemeEntry = { phoneme: 'A', startTime: 0, duration: 100, intensity: 0.5 };
    ...
    it('should return zeros for rest phoneme', () => {
        const entry: PhonemeEntry = { phoneme: 'X', startTime: 0, duration: 100, intensity: 0 };
        const shape = phonemeToMouthShape(entry);
    ...
    it('should handle all phoneme types', () => {
        const phonemes: Array<PhonemeEntry['phoneme']> = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'X'];

        for (const phoneme of phonemes) {
            const entry: PhonemeEntry = { phoneme, startTime: 0, duration: 100, intensity: 1.0 };
            const shape = phonemeToMouthShape(entry);
...
describe('createLipSyncGenerator factory', () => {
    it('should create generator with default config', () => {
        ...
        expect(generator.getConfig().averagePhoneDuration).toBe(DEFAULT_LIPSYNC_CONFIG.averagePhoneDuration);
    });
...
describe('DEFAULT_LIPSYNC_CONFIG', () => {
    it('should have sensible defaults', () => {
        ...
        expect(DEFAULT_LIPSYNC_CONFIG.maxPhoneDuration).toBeGreaterThan(DEFAULT_LIPSYNC_CONFIG.minPhoneDuration);
