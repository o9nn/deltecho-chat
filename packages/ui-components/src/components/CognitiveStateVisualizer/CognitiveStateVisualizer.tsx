...
export const CognitiveStateVisualizer: React.FC<CognitiveStateVisualizerProps> = ({ state, className = '' }) => {
    if (!state) {
        return (
    ...
    return (
        <div className={`dte-cognitive-visualizer ${className}`}>
            ...
            <div className="dte-grid">
                ...
                <div className="dte-section">
                    ...
                    <div className="dte-emotion-grid">
                        <EmotionBar label="Joy" value={emotionalState.joy} color="#ffd43b" />
                        <EmotionBar label="Sadness" value={emotionalState.sadness} color="#868e96" />
                        <EmotionBar label="Anger" value={emotionalState.anger} color="#fa5252" />
                        <EmotionBar label="Fear" value={emotionalState.fear} color="#be4bdb" />
                        <EmotionBar label="Surprise" value={emotionalState.surprise} color="#fab005" />
                        <EmotionBar label="Interest" value={emotionalState.interest} color="#4dabf7" />
                    </div>
                </div>
                ...
                <div className="dte-section">
                    ...
                    <div className="dte-phase-cycle">
                        <div className="dte-phase-circle" style={{
                            borderColor: `hsl(${currentPhase * 12}, 70%, 60%)`
                        }}>
                            {currentPhase}
                        </div>
                        <span className="dte-phase-label">Step {currentPhase + 1} of 30</span>
                    </div>
                </div>
                ...
                <div className="dte-section">
                    ...
                    <div className="dte-stream-list">
                        {activeStreams.length === 0 && <span className="dte-date">Idle</span>}
            ...
            <div style={{ marginTop: 12, fontSize: '0.75rem', color: '#5c5f66', textAlign: 'right' }}>
