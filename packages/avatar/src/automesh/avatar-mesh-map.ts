...
export const MELODY_MESH3D_GROUP_SPECS: readonly Mesh3dGroupSpec[] = [
  ...
  },
  {
    ...
    parameters: ["ParamArmL1", "ParamArmR1", "ParamSleeveL", "ParamSleeve"],
    deformBands: [],
    visibleInAPose: true,
  },
  {
  ...
  {
    id: "boots",
    label: "White platform boots",
    live2dRegions: ["legs"],
    physics: [],
    parameters: ["ParamLegL1X", "ParamLegR1X"],
    deformBands: ["boots"],
    visibleInAPose: true,
  },
  {
...
export const MELODY_LIVE2D_TO_3D: readonly Live2dTo3dBinding[] = [
  ...
  { region: "arms", mesh3d: ["gloves"] },
  { region: "skirt", mesh3d: ["skirt", "skirtBelts"] },
  { region: "legs", mesh3d: ["boots", "thighStrap"] },
