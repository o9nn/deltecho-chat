...
import { PixiLive2DRenderer, PARAM_IDS } from '../adapters/pixi-live2d-renderer';
import type { CubismAdapterConfig, CubismModelInfo } from '../adapters/cubism-adapter';
...
describe('PixiLive2DRenderer', () => {
    ...
    describe('initialization', () => {
        ...
        it('should throw if canvas element not found by ID', async () => {
            ...
            await expect(renderer.initialize(config)).rejects.toThrow('Canvas element not found');
        });
    });
    ...
    describe('parameter control', () => {
        ...
        it('should allow setting custom parameters', () => {
            expect(() => renderer.setParameter(PARAM_IDS.PARAM_ANGLE_X, 15)).not.toThrow();
        });
...
describe('createPixiLive2DRenderer', () => {
    it('should create a new renderer instance', async () => {
        const { createPixiLive2DRenderer } = await import('../adapters/pixi-live2d-renderer');
