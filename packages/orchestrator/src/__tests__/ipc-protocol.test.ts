...
describe('IPC Protocol', () => {
    describe('IPCMessageType', () => {
        it('should have cognitive message types', () => {
            ...
            expect(IPCMessageType.COGNITIVE_QUICK_PROCESS).toBe('cognitive:quick_process');
            expect(IPCMessageType.COGNITIVE_GET_STATE).toBe('cognitive:get_state');
            expect(IPCMessageType.COGNITIVE_GET_EMOTIONAL_STATE).toBe('cognitive:get_emotional_state');
        });
    ...
    describe('createIPCMessage', () => {
        it('should create a valid IPC message', () => {
            ...
            const message = createIPCMessage(IPCMessageType.COGNITIVE_PROCESS, payload);
    ...
    describe('isIPCMessage', () => {
        ...
        it('should return true for minimal valid object', () => {
            expect(isIPCMessage({ id: '1', type: 'ping', timestamp: 123 })).toBe(true);
        });
    });
